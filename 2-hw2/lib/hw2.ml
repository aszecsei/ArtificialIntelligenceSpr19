...
;;
(*
  The above sequence generated by A* is fairly obviously shorter than the one generated
  by greedyBF.
 *)
...
(*
  Using Manhattan distance definitely improved greedyBF...
 *)
...
(*
  ...but there was no improvement on A*.
 *)
